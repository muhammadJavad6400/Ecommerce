...
(function ($) {
    ...
    $(".slider-active-3").owlCarousel({
        ...
        autoplay: false,
        navText: [
            '<i class="sli sli-arrow-up"></i><span>Prev</span>',
            '<i class="sli sli-arrow-down"></i><span>Next</span>',
        ],
        autoplayTimeout: 5000,
        animateOut: "fadeOut",
        animateIn: "fadeIn",
    ...
    var activeId = $("#instafeed"),
        myTemplate =
            '<div class="instagram-item"><a href="{{link}}" target="_blank" id="{{id}}"><img src="{{image}}" /></a></div>';
    if (activeId.length) {
    ...
    $(".product-dec-slider").slick({
        ...
        slidesToScroll: 1,
        prevArrow:
            '<span class="product-dec-icon product-dec-prev"><i class="sli sli-arrow-left"></i></span>',
        nextArrow:
            '<span class="product-dec-icon product-dec-next"><i class="sli sli-arrow-right"></i></span>',
        responsive: [
            {
                breakpoint: 1199,
                settings: {
    ...
    $(".product-dec-slider-2").slick({
        ...
        centerPadding: "60px",
        prevArrow:
            '<span class="product-dec-icon product-dec-prev"><i class="sli sli-arrow-up"></i></span>',
        nextArrow:
            '<span class="product-dec-icon product-dec-next"><i class="sli sli-arrow-down"></i></span>',
        responsive: [
            {
                breakpoint: 1200,
                settings: {
